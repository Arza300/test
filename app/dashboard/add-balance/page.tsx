...
const WHATSAPP_NUMBER = "201023005622";
const VODAFONE_CASH_NUMBER = "01023005622";
...
export default async function AddBalancePage() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h2 className="mt-6 text-2xl font-bold text-[var(--color-foreground)]">
        إضافة رصيد
      </h2>
      <p className="mt-1 text-[var(--color-muted)]">
        اختر طريقة الدفع ثم اتبع التعليمات
      </p>
      ...
      <div className="mt-8 space-y-6">
        ...
        <section className="rounded-[var(--radius-card)] border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-[var(--shadow-card)]">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3">
            ...
            <CopyButton text={VODAFONE_CASH_NUMBER} />
          </div>
